...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { price_per_unity: @balance.price_per_unity, product_id: @balance.product_id, quantity: @balance.quantity, user_id: @balance.user_id } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { price_per_unity: @balance.price_per_unity, product_id: @balance.product_id, quantity: @balance.quantity, user_id: @balance.user_id } }
